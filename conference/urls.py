...
urlpatterns = [
    ...
    path('<int:conference_id>/room/', views.virtual_conference_room, name='virtual_conference_room'),
...
urlpatterns += [
    ...
    path('paper/<int:paper_id>/register/', views.conference_register, name='conference_register'),
    path('paper/<int:paper_id>/register/payment/', views.register_payment, name='register_payment'),
]