...
urlpatterns = [
    ...
    path('<int:conference_id>/room/', views.conference_room, name='conference_room'),
    path('<int:conference_id>/room/', views.conference_room, name='virtual_conference_room'),
    path('<int:conference_id>/token/', views.conference_token, name='conference_token'),
